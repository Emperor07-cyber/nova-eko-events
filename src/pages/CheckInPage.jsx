...
const styles = {
  page: {
    minHeight: "100vh",
    background:
      "radial-gradient(800px 220px at 50% 0%, rgba(124, 92, 255, 0.08), transparent 55%), linear-gradient(180deg, #f7f8fb 0%, #f3f5fa 100%)",
    display: "flex",
    alignItems: "center",
  ...
  subtitle: { color: "#64748b", fontSize: "0.95rem", marginBottom: "1rem", lineHeight: 1.6 },
  ...
  btn: {
    ...
    fontWeight: 700,
    cursor: "pointer",
    boxShadow: "0 10px 22px rgba(124, 92, 255, 0.28)",
  },
  scanPage: {
    minHeight: "100vh",
    background:
  ...
  scanCount: { color: "#5b46d8", fontSize: "0.85rem", margin: "4px 0 0", fontWeight: 600 },
  exitBtn: {
    background: "#fff",
    color: "#dc2626",
  ...
  historyItem: { display: "flex", justifyContent: "space-between", padding: "0.75rem 0", borderBottom: "1px solid #eef2f7", color: "#111827", fontSize: "0.9rem" },
};
